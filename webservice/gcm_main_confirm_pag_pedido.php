...
if(isset($_POST['gcm_push']) && $_POST['gcm_push'] == 'gcm_push_pagamento'){

	$trans_id = $_POST['trans_id'];
	$resposta = $_POST['resposta'];
	$trans_id_user2 = $_POST['trans_id_user2'];
	
	$rs_usu2 = $con->query("SELECT usu_token_gcm FROM usuarios WHERE usu_id_face =".$trans_id_user2);
    ...
    if($lista_transacoes){
		...
		$pushMessage = "Seu amigo(a) ".$lista_transacoes['trans_nome_user1']." esta solicitando que voce confirme o recebimento do pagamento do emprestimo.";
