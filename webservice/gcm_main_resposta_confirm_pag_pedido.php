...
if(isset($_POST['gcm_push']) && $_POST['gcm_push'] == 'gcm_push_resposta_pagamento'){
    ...
    if($lista_transacoes){
    	...
    	if($resposta == '2'){
			$pushMessage = "Seu amigo(a) ".$lista_transacoes['trans_nome_user2']." recusou sua solicitaçao de pagamento.";
		}else if ($resposta == '3'){
			$pushMessage = "Seu amigo(a) ".$lista_transacoes['trans_nome_user2']." aceitou sua solicitaçao de pagamento.";
		}
